        ...
        function getDynamicInformation(selector) {
            ...
            input.addEventListener('input', () => {
                if (input.value.match(/\D*/g)) {
                    const inputAlert = document.querySelector('#inputAlert span');
                    const div = document.createElement('div');
               
                    input.style.border = "1px solid red";
                    // div.textContent = 'Введите число!';
                    inputAlert.insertAdjacentElement('afterend', div);
...
function slider({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
     ...
     // window.getComputedStyle(wrapper) - объект со всеми примененными стилями
     // И из этого объекта вытаскиваем свойство с шириной 
...
// Основываясь на опред. кол-ве слайдов создаем опред. количество точек 
for (let i = 0; i < slides.length; i++){
   ...
   // Помещаем точку в массив, т.е. после отработки цикла получаем массив, который можем дальше использовать
   dots.push(dot);
}
...
/* harmony import */ var _modules_boxes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/boxes */ "./js/modules/boxes.js");
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    Object(_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2021-01-01');
    Object(_modules_boxes__WEBPACK_IMPORTED_MODULE_3__["default"])();
